...
#define BOARD1_MAC                                                             \
  { 0x30, 0xC6, 0xF7, 0x1F, 0xD7, 0x40 } // replace with your board's address
#define BOARD2_MAC                                                             \
  { 0x30, 0xC6, 0xF7, 0x2F, 0x38, 0x58 } // replace with your board's address

#define WIFI_CHAN                                                              \
  13 // 12-13 only legal in US in lower power mode, do not use 14
...
//#define DEBUG // for additional serial messages (may interfere with other
//messages)
...
#ifndef LED_BUILTIN
#define LED_BUILTIN                                                            \
  2 // some boards don't have an LED or have it connected elsewhere
#endif
